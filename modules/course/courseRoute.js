...
router.delete('/:id',(req, res)=>{
    courseModel.findByIdAndRemove(req.params.id).then(course =>{
         if(course){
              return res.status(200).json({success:true, message: "Course is deleted successfully"})
             } 
             else{
...
router.get('/get/count',async (req, res)=>{
    ...
    res.send({courseCount:courseCount})
